...
import { formatDate, getStatusColor } from '@/components/../lib/utils'
    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-lg text-gray-900 mb-2">Project Not Found</h3>
      ...
      <div className="p-8 max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="border-0 shadow-lg">
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="text-3xl text-gray-900">{sprintStats.totalSprints}</div>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="text-3xl text-gray-900">{sprintStats.completedSprints.length}</div>
              ...
              <div className="flex items-center justify-between">
                <div className="text-3xl text-gray-900">
                  {sprintStats.totalSprints > 0
                    ? Math.round((sprintStats.completedSprints.length / sprintStats.totalSprints) * 100)
                    : 0}
                  %
                </div>
